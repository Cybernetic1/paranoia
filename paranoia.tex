...
\includepdf[fitpaper=true]{\cc{cover1-mong}{cover1-en}}
\cleardoublepage
\title{\Huge{\cc{妄想症}{Paranoia}}}
\author{\cc{甄景贤}{John Yan (\usebox{\MyName})}}
% \date{27 May 2015}
% \institute{}
...
% 欢迎读者们提问或提供意见：
\cc{作者电邮：}{author e-mail:} general.intelligence@gmail.com
...
\cc{封面插图：}{cover art:}  ``Paranoia or something'' \\
...
Actually in the summer of 1991, just days after knowing each other, she had changed her mind, saying, ``I just want an elder brother, to beat up the people who bully me''.  I remember my first response was ``Huh? Beat up who?''

For \resultb ~years I kept thinking why she rejected me.

At 14 years' age she said: ``George Bush (Senior) is fighting a war in Iraq, but he still goes to play golf!''  I said:  we Hong Kong people don't care about politics, we don't know what is war --- and stupid things like that.  Now I realize, that what she said was very right, she was so young but she understood a lot.  And now I know the correct response should be that we should knock down American imperialism and racism.
}
...
\chapter{\cc{监视下的日常生活}{Life under surveillance}}
...
\chapter{\cc{精神病院}{Mental hospital}}
...
\chapter*{\cc{附录 A ~~~ 关於精神科药物}{Appendix A ~~~ About psychiatric drugs}}
\addcontentsline{toc}{chapter}{\cc{附录 A ~ 关於精神科药物}{Appendix A ~ about psychiatric drugs}}

\cc{
实在有太多精神科药物的受害者，我觉得要写篇比较详细的解释，不用每次重复。
}{
So many people are affected by the harmful effects of anti-psychotic drugs, that I feel obliged to write this, so I won't need to explain the same things repeatedly.
}

\section{\cc{人脑是靠神经细胞思考的}{The human brain thinks with neurons}}

\cc{
首先，人脑是靠这些神经细胞来思考的：
}{
First, the human brain performs thinking using neurons that look like this:
}
\begin{figure}[H]
\centering
...
From 2004, I focused my research on artificial intelligence, because this technology will have an even greater impact on humanity, and the mystery of the brain will also be solved via the use of AI.
}

\cc{
希望這篇文章能幫到我的病友們。
}{
I hope this article could some day help the friends that I've known in mental hospitals.
}

\vignette

PS:  This blog article was first written in 2014.  I have not been studying neuroscience in recent years, but I do keep an eye to stay abreast on latest research progress.  I am not aware of any new findings that contradict my view, and if anything, I feel even more vindicated as there are more books appearing that criticizes psychiatric drugs.  I am not the only whistle-blower:

\begin{itemize}
	\item {[Robert Whitaker 2002]} Mad in America: Bad Science, Bad Medicine, and the Enduring Mistreatment of the Mentally Ill 

	\item {[Peter R. Breggin 2007]} Brain-Disabling Treatments in Psychiatry: Drugs, Electroshock, and the Psychopharmaceutical Complex, 2nd ed.


	\item {[Joanna Moncrieff 2008]} The Myth of the Chemical Cure: A Critique of Psychiatric Drug Treatment
\end{itemize}
There are too many books / articles to cite.  These are just 3 random results from Google.
